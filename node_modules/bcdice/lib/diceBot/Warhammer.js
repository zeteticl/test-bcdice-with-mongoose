...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$upcase', '$===', '$last_match', '$getAttackResult', '$getCriticalResult', '$==', '$<=', '$div', '$-', '$=~', '$to_i', '$>', '$<', '$roll', '$*', '$/', '$[]', '$+', '$>=', '$debug', '$!=', '$each', '$get_wh_atpos_message', '$step', '$length', '$check_1D100', '$%', '$wh_atpos']);
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$check_1D100', $Warhammer_check_1D100$3 = function $$check_1D100(total, _dice_total, cmp_op, target) {
      ...
      if ($truthy($rb_le(total, target))) {
        return "" + " ＞ 成功(成功度" + ($rb_minus(target, total).$div(10)) + ")"
      } else {
        return "" + " ＞ 失敗(失敗度" + ($rb_minus(total, target).$div(10)) + ")"
      };
