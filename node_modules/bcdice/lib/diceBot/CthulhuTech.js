...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$setPrefixes', '$include', '$new', '$[]', '$roll', '$>=', '$count', '$div', '$+', '$length', '$sort', '$calculate_roll_result', '$-', '$!', '$send', '$class', '$expression', '$test_value_expression', '$result_str', '$join', '$private', '$format_modifier', '$last', '$sum_of_highest_set_of_multiples', '$sum_of_largest_straight', '$max', '$map', '$group_by', '$reduce', '$to_proc', '$<', '$each', '$uniq', '$>', '$ceil', '$/', '$parse', '$execute', '$freeze', '$match', '$to_i', '$eval', '$==']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.def(self, '$execute', $Test_execute$2 = function $$execute(bot) {
        ...
        fumble = $rb_ge(dice_values.$count(1), $rb_plus(dice_values.$length(), 1).$div(2));
