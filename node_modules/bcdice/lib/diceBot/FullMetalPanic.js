...
Opal.modules["diceBot/SRS"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$include', '$attr_reader', '$map', '$to_proc', '$join', '$escape', '$new', '$prepare_help_msg_for_aliases_for_srs_roll', '$concatenate_help_messages', '$private', '$clear_aliases_for_srs_roll', '$extend', '$setPrefixes', '$help_message', '$class', '$freeze', '$format_modifier', '$modifier', '$target_value', '$critical_value', '$fumble_value', '$replace_alias_for_srs_roll_with_2d6', '$parse', '$execute_srs_roll', '$===', '$aliases_re_for_srs_roll_with_target_value', '$last_match', '$aliases_re_for_srs_roll_without_target_value', '$parse_srs_roll_with_target_value', '$parse_srs_roll_without_target_value', '$eval', '$to_sym', '$eval_modifier', '$[]', '$to_i', '$roll', '$&', '$+', '$compare_result', '$compact', '$>=', '$<=']);
