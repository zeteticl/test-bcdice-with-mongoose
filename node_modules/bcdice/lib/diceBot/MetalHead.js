...
Opal.modules["utils/range_table"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.const_set($nesting[0], 'DEFAULT_FORMATTER', $send(self, 'lambda', [], ($$2 = function(table, result){var self = $$2.$$s || this;
...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $MetalHead_rollDiceCommand$1, $MetalHead_changeText$2, $MetalHead_check_2D6$5, $MetalHead_rollHit$6, $MetalHead_check_1D100$7, $MetalHead_getHitResult$8, $MetalHead_getResult$9, $MetalHead_mh_crc_table$10;
    ...
    Opal.const_set($nesting[0], 'TABLE_ROLL_RESULT_FORMATTER', $send(self, 'lambda', [], ($$13 = function(table, result){var self = $$13.$$s || this;
      ...
      return [table.$name(), result.$sum(), result.$content()].$join(" ＞ ");}, $$13.$$s = self, $$13.$$arity = 2, $$13)));
