...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$=~', '$prefixesPattern', '$class', '$last_match', '$upcase', '$getCommandResult', '$!=', '$==', '$size', '$-', '$<=', '$>=', '$===', '$get_table_by_nD6', '$to_i', '$roll', '$+', '$>', '$[]', '$<', '$getTrapTable', '$nil?', '$div', '$getTresureTable', '$get_table_by_1d6', '$!', '$getRandomEvent', '$get_table_by_d66', '$getLotResult', '$lambda', '$to_s', '$normal2', '$normal3', '$normal4', '$normal5', '$premium5', '$premium2', '$premium3', '$premium4', '$premium6', '$premium1', '$normal1', '$getRandomDiff', '$get_table_by_number']);
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$normal1', $GurpsFW_normal1$5 = function $$normal1() {
      var $a, $b, self = this, table = nil, result = nil;

      
      table = ["イレブンチキン", "イレブンチキン", "イレブンチキン", $send(self, 'lambda', [], ($$6 = function(){var self = $$6.$$s || this;

      return self.$normal2().$to_s()}, $$6.$$s = self, $$6.$$arity = 0, $$6)), $send(self, 'lambda', [], ($$7 = function(){var self = $$7.$$s || this;

      return self.$normal2().$to_s()}, $$7.$$s = self, $$7.$$arity = 0, $$7)), $send(self, 'lambda', [], ($$8 = function(){var self = $$8.$$s || this;

      return self.$normal3().$to_s()}, $$8.$$s = self, $$8.$$arity = 0, $$8))];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
      return result;
    }, $GurpsFW_normal1$5.$$arity = 0);
    
    Opal.def(self, '$normal2', $GurpsFW_normal2$9 = function $$normal2() {
      var $a, $b, self = this, table = nil, result = nil;

      
      table = ["バロールたわし", "イグニスジッポ", "ヤコ仮面or梟の文鎮(選択可)", "ナレッジのハンモックorジンジャビースト", $send(self, 'lambda', [], ($$10 = function(){var self = $$10.$$s || this;

      return self.$normal3().$to_s()}, $$10.$$s = self, $$10.$$arity = 0, $$10)), $send(self, 'lambda', [], ($$11 = function(){var self = $$11.$$s || this;

      return self.$normal3().$to_s()}, $$11.$$s = self, $$11.$$arity = 0, $$11))];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
      return result;
    }, $GurpsFW_normal2$9.$$arity = 0);
    
    Opal.def(self, '$normal3', $GurpsFW_normal3$12 = function $$normal3() {
      var $a, $b, self = this, table = nil, result = nil;

      
      table = ["特性HPポーション", "特性MPポーション", "黒い甲冑", "天体望遠鏡", "金獅子の剥製", $send(self, 'lambda', [], ($$13 = function(){var self = $$13.$$s || this;

      return self.$normal4().$to_s()}, $$13.$$s = self, $$13.$$arity = 0, $$13))];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
      return result;
    }, $GurpsFW_normal3$12.$$arity = 0);
    
    Opal.def(self, '$normal4', $GurpsFW_normal4$14 = function $$normal4() {
      var $a, $b, self = this, table = nil, result = nil;

      
      table = ["特性スタミナポーション", "戦乙女の兜", "フェンリルの首輪", "フェニックスカーペット", "動くアダマンゴーレム", $send(self, 'lambda', [], ($$15 = function(){var self = $$15.$$s || this;

      return self.$normal5().$to_s()}, $$15.$$s = self, $$15.$$arity = 0, $$15))];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
      return result;
    }, $GurpsFW_normal4$14.$$arity = 0);
    
    Opal.def(self, '$normal5', $GurpsFW_normal5$16 = function $$normal5() {
      var $a, $b, self = this, table = nil, result = nil;

      
      table = ["キャンディークッション", "屑鉄の金床", "薪割り王の斧", "ロジエの水差し", "箱舟の模型", $send(self, 'lambda', [], ($$17 = function(){var self = $$17.$$s || this;

      return self.$premium5().$to_s()}, $$17.$$s = self, $$17.$$arity = 0, $$17))];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
      return result;
    }, $GurpsFW_normal5$16.$$arity = 0);
    
    Opal.def(self, '$premium1', $GurpsFW_premium1$18 = function $$premium1() {
      var $a, $b, self = this, table = nil, result = nil;

      
      table = ["プレミアムチキン", "プレミアムチキン", "プレミアムチキン", $send(self, 'lambda', [], ($$19 = function(){var self = $$19.$$s || this;

      return self.$normal3().$to_s()}, $$19.$$s = self, $$19.$$arity = 0, $$19)), $send(self, 'lambda', [], ($$20 = function(){var self = $$20.$$s || this;

      return self.$premium2().$to_s()}, $$20.$$s = self, $$20.$$arity = 0, $$20)), $send(self, 'lambda', [], ($$21 = function(){var self = $$21.$$s || this;

      return self.$premium2().$to_s()}, $$21.$$s = self, $$21.$$arity = 0, $$21))];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
      return result;
    }, $GurpsFW_premium1$18.$$arity = 0);
    
    Opal.def(self, '$premium2', $GurpsFW_premium2$22 = function $$premium2() {
      var $a, $b, self = this, table = nil, result = nil;

      
      table = ["親衛隊バッジ", "ハタモトチャブダイ", "星のコンパス", "白銀の甲冑", $send(self, 'lambda', [], ($$23 = function(){var self = $$23.$$s || this;

      return self.$normal4().$to_s()}, $$23.$$s = self, $$23.$$arity = 0, $$23)), $send(self, 'lambda', [], ($$24 = function(){var self = $$24.$$s || this;

      return self.$premium3().$to_s()}, $$24.$$s = self, $$24.$$arity = 0, $$24))];
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
      return result;
    }, $GurpsFW_premium2$22.$$arity = 0);
    
    Opal.def(self, '$premium3', $GurpsFW_premium3$25 = function $$premium3() {
      var $a, $b, self = this, table = nil, result = nil;
