...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$setPrefixes', '$freeze', '$source', '$new', '$match', '$bRollCommand', '$[]', '$integerValueOfDifficulty', '$debug', '$roll', '$bcdice', '$parse', '$===', '$executeEV', '$executeAT', '$executeEL', '$private', '$parseEV', '$last_match', '$parseAT', '$parseEL', '$to_i', '$num', '$difficulty', '$sub', '$bdice', '$targetValue', '$raise', '$>', '$map', '$split', '$to_proc', '$length', '$select', '$==', '$>=', '$+', '$fetch', '$upcase', '$keys']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.const_set($nesting[0], 'DIFFICULTY_RE', new RegExp("" + "(?:\\[(" + ($$($nesting, 'DIFFICULTY_VALUE_RE').$source()) + ")\\]|@(" + ($$($nesting, 'DIFFICULTY_VALUE_RE').$source()) + "))", 'i').$freeze());
    Opal.const_set($nesting[0], 'NJ_RE', new RegExp("" + "^(S)?NJ(\\d+)" + ($$($nesting, 'DIFFICULTY_RE').$source()) + "?$", 'i').$freeze());
    Opal.const_set($nesting[0], 'EV_RE', new RegExp("" + "^EV(\\d+)" + ($$($nesting, 'DIFFICULTY_RE').$source()) + "?(?:/(\\d+))?$", 'i').$freeze());
    Opal.const_set($nesting[0], 'AT_RE', new RegExp("" + "^AT(\\d+)" + ($$($nesting, 'DIFFICULTY_RE').$source()) + "?$", 'i').$freeze());
    Opal.const_set($nesting[0], 'EL_RE', new RegExp("" + "^EL(\\d+)" + ($$($nesting, 'DIFFICULTY_RE').$source()) + "?$", 'i').$freeze());
