...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$checkRoll', '$nil?', '$===', '$last_match', '$==', '$getLotResult', '$getSpecialResult', '$to_i', '$getCookResult', '$getTrapResult', '$getTresureResult', '$getRandomEventResult', '$getRandomEnemyDataResult', '$getRandomOptionResult', '$getValue', '$roll', '$+', '$<=', '$>=', '$-', '$empty?', '$parren_killer', '$first', '$<', '$last', '$>', '$get_table_by_1d6', '$cook', '$lambda', '$name', '$class', '$[]', '$premium', '$normal', '$get_table_by_nD6', '$get_table_by_d66', '$div', '$get_table_by_number']);
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$cook', $FilledWith_cook$8 = function $$cook(lv, num) {
      var $a, $b, self = this, $case = nil, table = nil, result = nil, number = nil;

      
      $case = lv;
      if ((1)['$===']($case)) {table = ["おべんとミートボール", "パリパリ小魚", "キャロットタルト", "おにぎり", $send(self, 'lambda', [], ($$9 = function(){var self = $$9.$$s || this;

      return self.$cook(2, 5)}, $$9.$$s = self, $$9.$$arity = 0, $$9)), $send(self, 'lambda', [], ($$10 = function(){var self = $$10.$$s || this;

      return self.$cook(2, 6)}, $$10.$$s = self, $$10.$$arity = 0, $$10))]}
      else if ((2)['$===']($case)) {table = ["カリカリミミズ肉", "竹つきチクワ", "トロピカルジュース", "イナリ寿司", $send(self, 'lambda', [], ($$11 = function(){var self = $$11.$$s || this;

      return self.$cook(3, 5)}, $$11.$$s = self, $$11.$$arity = 0, $$11)), $send(self, 'lambda', [], ($$12 = function(){var self = $$12.$$s || this;

      return self.$cook(3, 6)}, $$12.$$s = self, $$12.$$arity = 0, $$12))]}
      else if ((3)['$===']($case)) {table = ["ホットミートパイ", "魔界魚の目玉", "パンプキンプリン", "スタミナ丼", $send(self, 'lambda', [], ($$13 = function(){var self = $$13.$$s || this;

      return self.$cook(4, 5)}, $$13.$$s = self, $$13.$$arity = 0, $$13)), $send(self, 'lambda', [], ($$14 = function(){var self = $$14.$$s || this;

      return self.$cook(4, 6)}, $$14.$$s = self, $$14.$$arity = 0, $$14))]}
      else if ((4)['$===']($case)) {table = ["ジャンボ串焼き", "シルヴァまっしぐら", "フラウアイスクリーム", "ピクニックランチ", $send(self, 'lambda', [], ($$15 = function(){var self = $$15.$$s || this;

      return self.$cook(5, 5)}, $$15.$$s = self, $$15.$$arity = 0, $$15)), $send(self, 'lambda', [], ($$16 = function(){var self = $$16.$$s || this;

      return self.$cook(5, 6)}, $$16.$$s = self, $$16.$$arity = 0, $$16))]}
      else if ((5)['$===']($case)) {table = ["グラント風香草焼き", "エドマエスシ", "スターフルーツパフェ", "具沢山本格カレー", $send(self, 'lambda', [], ($$17 = function(){var self = $$17.$$s || this;

      return self.$cook(6, 5)}, $$17.$$s = self, $$17.$$arity = 0, $$17)), $send(self, 'lambda', [], ($$18 = function(){var self = $$18.$$s || this;

      return self.$cook(6, 6)}, $$18.$$s = self, $$18.$$arity = 0, $$18))]}
      else if ((6)['$===']($case)) {table = ["ドラゴンステーキ", "刺身盛り合わせ", "エデンのアップルパイ", "フォートレス炒飯", $send(self, 'lambda', [], ($$19 = function(){var self = $$19.$$s || this;

      return self.$cook(7, 5)}, $$19.$$s = self, $$19.$$arity = 0, $$19)), $send(self, 'lambda', [], ($$20 = function(){var self = $$20.$$s || this;

      return self.$cook(7, 6)}, $$20.$$s = self, $$20.$$arity = 0, $$20))]}
      else if ((7)['$===']($case)) {table = ["マツザカスペシャル", "オオトロスシ", "スノーホワイトボンブ", "よもつへぐい", $send(self, 'lambda', [], ($$21 = function(){var self = $$21.$$s || this;

      return self.$cook(8, 5)}, $$21.$$s = self, $$21.$$arity = 0, $$21)), $send(self, 'lambda', [], ($$22 = function(){var self = $$22.$$s || this;

      return self.$cook(8, 6)}, $$22.$$s = self, $$22.$$arity = 0, $$22))]}
      else if ((8)['$===']($case)) {table = ["超特大マンガ肉", "特上うな丼", "魔将樹のかき氷", "ヘブンズランチ", $send(self, 'lambda', [], ($$23 = function(){var self = $$23.$$s || this;

      return self.$cook(9, 5)}, $$23.$$s = self, $$23.$$arity = 0, $$23)), $send(self, 'lambda', [], ($$24 = function(){var self = $$24.$$s || this;

      return self.$cook(9, 6)}, $$24.$$s = self, $$24.$$arity = 0, $$24))]}
    ...
    Opal.def(self, '$normal', $FilledWith_normal$26 = function $$normal(phase, num) {
      var $a, $b, self = this, $case = nil, table = nil, result = nil, number = nil;
      ...
      return self.$normal(2, 4)}, $$27.$$s = self, $$27.$$arity = 0, $$27)), $send(self, 'lambda', [], ($$28 = function(){var self = $$28.$$s || this;

      return self.$normal(2, 5)}, $$28.$$s = self, $$28.$$arity = 0, $$28)), $send(self, 'lambda', [], ($$29 = function(){var self = $$29.$$s || this;

      return self.$normal(3, 6)}, $$29.$$s = self, $$29.$$arity = 0, $$29))]}
      else if ((2)['$===']($case)) {table = ["バロールたわし", "イグニスジッポ", "ヤコ仮面or梟の文鎮(選択可)", "ナレッジのハンモックorジンジャビースト", $send(self, 'lambda', [], ($$30 = function(){var self = $$30.$$s || this;

      return self.$normal(3, 5)}, $$30.$$s = self, $$30.$$arity = 0, $$30)), $send(self, 'lambda', [], ($$31 = function(){var self = $$31.$$s || this;

      return self.$normal(3, 6)}, $$31.$$s = self, $$31.$$arity = 0, $$31))]}
      else if ((3)['$===']($case)) {table = ["特性HPポーション", "特性MPポーション", "黒い甲冑", "天体望遠鏡", "金獅子の剥製", $send(self, 'lambda', [], ($$32 = function(){var self = $$32.$$s || this;

      return self.$normal(4, 6)}, $$32.$$s = self, $$32.$$arity = 0, $$32))]}
      else if ((4)['$===']($case)) {table = ["特性スタミナポーション", "戦乙女の兜", "フェンリルの首輪", "フェニックスカーペット", "動くアダマンゴーレム", $send(self, 'lambda', [], ($$33 = function(){var self = $$33.$$s || this;

      return self.$normal(5, 6)}, $$33.$$s = self, $$33.$$arity = 0, $$33))]}
      else if ((5)['$===']($case)) {table = ["キャンディークッション", "屑鉄の金床", "薪割り王の斧", "ロジエの水差し", "箱舟の模型", $send(self, 'lambda', [], ($$34 = function(){var self = $$34.$$s || this;

      return self.$premium(5, 6)}, $$34.$$s = self, $$34.$$arity = 0, $$34))]};
      $b = self.$get_table_by_1d6(table), $a = Opal.to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
      if (result.$class().$name()['$==']("Array")) {
    ...
    Opal.def(self, '$premium', $FilledWith_premium$35 = function $$premium(phase, num) {
      var $a, $b, self = this, $case = nil, table = nil, result = nil, number = nil;
      ...
      return self.$normal(3, 4)}, $$36.$$s = self, $$36.$$arity = 0, $$36)), $send(self, 'lambda', [], ($$37 = function(){var self = $$37.$$s || this;

      return self.$premium(2, 5)}, $$37.$$s = self, $$37.$$arity = 0, $$37)), $send(self, 'lambda', [], ($$38 = function(){var self = $$38.$$s || this;

      return self.$premium(2, 6)}, $$38.$$s = self, $$38.$$arity = 0, $$38))]}
      else if ((2)['$===']($case)) {table = ["親衛隊バッジ", "ハタモトチャブダイ", "星のコンパス", "白銀の甲冑", $send(self, 'lambda', [], ($$39 = function(){var self = $$39.$$s || this;

      return self.$normal(4, 5)}, $$39.$$s = self, $$39.$$arity = 0, $$39)), $send(self, 'lambda', [], ($$40 = function(){var self = $$40.$$s || this;

      return self.$premium(3, 6)}, $$40.$$s = self, $$40.$$arity = 0, $$40))]}
      ...
      return self.$premium(4, 6)}, $$41.$$s = self, $$41.$$arity = 0, $$41))]}
      ...
      return self.$premium(5, 6)}, $$42.$$s = self, $$42.$$arity = 0, $$42))]}
      ...
      return self.$premium(6, 6)}, $$43.$$s = self, $$43.$$arity = 0, $$43))]}
