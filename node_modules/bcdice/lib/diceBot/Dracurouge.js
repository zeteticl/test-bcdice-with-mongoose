...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$getGloryDiceCount', $Dracurouge_getGloryDiceCount$7 = function $$getGloryDiceCount(diceList) {
      ...
      gloryDiceCount = $rb_plus(oneCount.$div(2), sixCount.$div(2));
