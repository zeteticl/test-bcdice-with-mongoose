  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$getCheckResultText', $Cthulhu7th_getCheckResultText$10 = function $$getCheckResultText(total, diff, fumbleable) {
      ...
      if ($truthy($rb_le(total, diff))) {
        ...
        if (total['$=='](1)) {
          return "クリティカル"};
        if ($truthy($rb_le(total, diff.$div(5)))) {
          return "イクストリーム成功"};
        if ($truthy($rb_le(total, diff.$div(2)))) {
          return "ハード成功"};
        return "レギュラー成功";};
      fumble_text = "ファンブル";
      if (total['$=='](100)) {
    ...
    Opal.def(self, '$getFullAutoResult', $Cthulhu7th_getFullAutoResult$12 = function $$getFullAutoResult(command) {
      ...
      bullet_set_count_cap = ($truthy($a = $$($nesting, 'Regexp').$last_match(6)) ? $a : diff.$div(10)).$to_i();
      output = "";
      ...
      if ($truthy(($truthy($a = ($truthy($b = $rb_gt(bullet_set_count_cap, diff.$div(10))) ? $rb_gt(diff, 39) : $b)) ? $$($nesting, 'Regexp').$last_match(6)['$nil?']()['$!']() : $a))) {
