...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$setPrefixes', '$bcdice', '$set2Decks2Jokers', '$cardTrader', '$card_place=', '$-', '$canTapCard=', '$==', '$<=', '$>=', '$+', '$>', '$start_with?', '$roll_fate_table', '$cf_roll', '$private', '$match', '$[]', '$to_i', '$include?', '$div', '$%', '$!', '$roll', '$new', '$parse', '$command', '$critical', '$fumble', '$dollar=', '$<', '$cmp_op', '$modify_number', '$compact', '$to_s', '$target_number', '$difference', '$join', '$-@', '$freeze']);
