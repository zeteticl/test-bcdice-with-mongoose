...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$match', '$[]', '$make_dice_roll', '$+', '$get_critical_success', '$to_i', '$>', '$>=', '$get_success_result', '$get_fail_result', '$<', '$==', '$*', '$div', '$roll', '$each', '$split']);
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$get_critical_success', $VampireTheMasquerade5th_get_critical_success$2 = function $$get_critical_success(ten_dice) {
      ...
      return $rb_times(ten_dice.$div(2), 2)
