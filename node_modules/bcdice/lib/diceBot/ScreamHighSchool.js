...
Opal.modules["diceBot/GardenOrder"] = function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$===', '$to_i', '$last_match', '$get_critical_border', '$check_roll_repeat_attack', '$look_up_damage_chart', '$nil?', '$max', '$div', '$check_roll', '$<', '$roll', '$get_check_result', '$<=', '$>=', '$get_damage_table_info_by_type', '$get_table_by_number', '$[]', '$freeze']);
