...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$===', '$check_1D12', '$getTrapResult', '$getEscapeExperienceTableResult', '$roll_tables', '$debug', '$match', '$to_i', '$parren_killer', '$[]', '$+', '$div', '$roll', '$==', '$<=', '$freeze', '$new', '$setPrefixes', '$keys']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$check_1D12', $KemonoNoMori_check_1D12$2 = function $$check_1D12(command, is_action_judge) {
      ...
      success_degree = (function() {if ($truthy(is_action_judge)) {
        return $rb_plus(target_total.$div(10), 1)
      } else {
        return 1
      }; return nil; })();
