...
(function(Opal) {
  ...
  Opal.add_stubs(['$setPrefixes', '$debug', '$getJudgeResult', '$nil?', '$navigationResult', '$getFireResult', '$getBomberResult', '$getAvoidResult', '$match', '$empty?', '$[]', '$to_i', '$roll', '$<=', '$div', '$+', '$freeze', '$to_s', '$min', '$getFirePoint', '$getFirePointText', '$!=', '$getDirectionInfo', '$times', '$<<', '$each', '$split', '$getMovePoint', '$isInMapPosition', '$join', '$===', '$slice', '$last_match', '$scanFirePoints', '$size', '$gsub', '$[]=', '$-']);
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$navigationResult', $Skynauts_navigationResult$4 = function $$navigationResult(command) {
      ...
      movePointBase = (function() {if ($truthy($rb_le(total.$div(2), 0))) {
        return 1
      } else {
        return total.$div(2)
      }; return nil; })();
